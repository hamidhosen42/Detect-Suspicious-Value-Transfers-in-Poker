# %% [markdown]
# # Step 6 — Exposure-matched training for *Detect Suspicious Value Transfers in Poker*
#
...
WORK_DIR = Path("/kaggle/working/step6") if Path("/kaggle/working").exists() else Path(os.environ.get("POKER_WORK_DIR", "./work_step6"))
...
DEV_PF = WORK_DIR / "dev_pair_features_v6.parquet"
