...
"""
import os, argparse, os, sys, time, warnings
import numpy as np, polars as pl, pandas as pd
warnings.filterwarnings("ignore")

ROOT = os.environ.get("POKER_ROOT", ".").rstrip("/") + "/"
D = os.environ.get("POKER_DATA_DIR", ROOT + "data").rstrip("/") + "/"; W = os.environ.get("POKER_WORK_DIR", ROOT + "work_step3").rstrip("/") + "/"; H = W + "hyp/"
B5 = 15 ** 5
NTHREADS = 3
TE_M = 30.0
RANKS = "23456789TJQKA"
