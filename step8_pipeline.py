# %% [markdown]
# # Step 8 — Action-level policy surprise + hard-negative PU for *Detect Suspicious Value Transfers in Poker*
#
...
WORK_DIR = Path("/kaggle/working/step8") if Path("/kaggle/working").exists() else Path(os.environ.get("POKER_WORK_DIR", "./work_step6"))
...
# %%
EVAL_SCORED = WORK_DIR / "eval_hand_scored_v8.parquet"
...
eval_pf.to_parquet(WORK_DIR / "eval_pair_features_v8.parquet", index=False)
