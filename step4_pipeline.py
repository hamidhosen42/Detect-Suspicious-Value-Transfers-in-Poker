# %% [markdown]
# # Step 4 — Two-stage evidence re-ranking + planted-hand counts for *Detect Suspicious Value Transfers in Poker*
#
...
WORK_DIR = Path("/kaggle/working/step4") if Path("/kaggle/working").exists() else Path(os.environ.get("POKER_WORK_DIR", "./work_step4"))
...
DEV_PF = WORK_DIR / "dev_pair_features_v4.parquet"
